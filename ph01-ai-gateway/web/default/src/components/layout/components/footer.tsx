    ...
    return (
      ...
      >
        <div className='mx-auto w-full max-w-6xl px-6 py-5'>
          <div className='bg-muted/20 border-border/50 flex flex-col items-center justify-between gap-4 rounded-xl border px-4 py-4 backdrop-blur-sm sm:flex-row sm:px-5'>
            <div
