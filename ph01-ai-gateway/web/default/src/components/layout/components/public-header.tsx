...
export function PublicHeader(props: PublicHeaderProps) {
  ...
  const notifications = useNotifications({ enabled: showNotifications })
        ...
        >
          <nav
            className={cn(
              ...
              scrolled
                ? 'bg-background/90 ring-border/50 h-12 rounded-xl pr-1.5 pl-4 shadow-[0_2px_14px_-10px_rgba(29,94,255,0.24),0_0_0_0.5px_rgba(29,94,255,0.08)] ring-[0.5px] backdrop-blur-md dark:shadow-[0_2px_14px_-10px_rgba(120,215,255,0.24)]'
                : 'h-16 px-2'
            )}
          >
            {/* Logo */}
