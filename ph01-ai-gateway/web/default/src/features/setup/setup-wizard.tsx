...
export function SetupWizard() {
  ...
  return (
    <div className='relative min-h-svh py-10'>
      ...
      <div className='container mx-auto flex max-w-5xl flex-col gap-8 px-4 sm:px-6'>
        ...
        <Card className='bg-card/90 border-border/70 shadow-[0_24px_80px_-56px_rgb(29_94_255_/_0.6)] backdrop-blur-xl dark:shadow-[0_28px_92px_-58px_rgb(120_215_255_/_0.42)]'>
