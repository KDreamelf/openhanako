                ...
                ({ value, titleKey, descriptionKey, icon: Icon }) => {
                  ...
                  return (
                    <Label
                      ...
                      className={cn(
                        'hover:border-primary/40 focus-within:border-primary/50 group bg-card flex cursor-pointer flex-col gap-3 rounded-lg border p-4 font-normal transition-all',
                        isSelected
