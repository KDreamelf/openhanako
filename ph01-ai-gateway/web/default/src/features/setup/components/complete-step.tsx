...
export function CompleteStep({ status, values }: CompleteStepProps) {
  ...
  return (
    <div className='flex flex-col items-center gap-6 text-center'>
      <div className='bg-primary/10 text-primary dark:bg-primary/15 rounded-lg p-4'>
      ...
      <div className='bg-card w-full rounded-lg border p-6 text-left shadow-sm sm:p-8'>
