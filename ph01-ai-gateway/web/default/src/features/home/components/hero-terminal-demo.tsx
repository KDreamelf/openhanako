...
type AccentTone = 'sky' | 'cyan' | 'blue' | 'indigo'
...
> = {
  sky: {
    ...
    activeBorder: 'border-sky-500 dark:border-sky-300',
    badge: 'bg-sky-500/10 text-sky-600 dark:bg-sky-300/10 dark:text-sky-300',
  },
  cyan: {
    activeText: 'text-cyan-600 dark:text-cyan-300',
    activeBorder: 'border-cyan-500 dark:border-cyan-300',
    badge:
      'bg-cyan-500/10 text-cyan-600 dark:bg-cyan-300/10 dark:text-cyan-300',
  },
  blue: {
    activeText: 'text-blue-600 dark:text-blue-300',
    activeBorder: 'border-blue-500 dark:border-blue-300',
    badge:
      'bg-blue-500/10 text-blue-600 dark:bg-blue-300/10 dark:text-blue-300',
  },
  indigo: {
    activeText: 'text-indigo-600 dark:text-indigo-300',
    activeBorder: 'border-indigo-500 dark:border-indigo-300',
    badge:
      'bg-indigo-500/10 text-indigo-600 dark:bg-indigo-300/10 dark:text-indigo-300',
  },
}
    ...
    <div className='mx-auto mt-16 w-full max-w-2xl'>
      <div
        className={cn(
          ...
          'dark:border-white/[0.06] dark:bg-[#071426]/95 dark:shadow-[0_20px_60px_-25px_rgba(0,0,0,0.7)]'
        )}
      >
        {/* Tab strip */}
        <div
        ...
        >
          ...
          <div className='ml-auto flex items-center gap-2 pr-2 sm:pr-3'>
            <span className='inline-block size-1.5 rounded-full bg-cyan-400 shadow-[0_0_8px_rgba(34,211,238,0.45)]' />
