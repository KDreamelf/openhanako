            ...
            >
              ...
              <Card>
                <Form.Section text={t('配置 Passkey')}>
                  <Text>{t('用以支持基于 WebAuthn 的无密码登录')}</Text>
                  <Banner
                    type='info'
                    description={t(
              ...
              <Card>
                <Form.Section text={t('配置 GitHub OAuth App')}>
                  <Text>{t('用以支持通过 GitHub 进行登录')}</Text>
                  <Banner
                    type='info'
              ...
              <Card>
                <Form.Section text={t('配置 Discord OAuth')}>
                  <Text>{t('用以支持通过 Discord 进行登录')}</Text>
                  <Banner
                    type='info'
              ...
              <Card>
                <Form.Section text={t('配置 Telegram 登录')}>
                  <Text>{t('用以支持通过 Telegram 进行登录')}</Text>
                  <Row
                    gutter={{ xs: 8, sm: 16, md: 24, lg: 24, xl: 24, xxl: 24 }}
                  >
                    <Col xs={24} sm={24} md={12} lg={12} xl={12}>
